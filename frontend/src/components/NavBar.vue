  ...
  <nav class="bg-gray-900 border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <div class="flex items-center space-x-4">
        <router-link to="/" class="text-lg font-bold text-white">TIME MANAGER</router-link>
      </div>
      <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <button type="button"
          :class="`flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-600 ${username ? '' : 'hidden'}`"
        ...
        <!-- Dropdown menu -->
        <div class="z-50 hidden my-4 text-base list-none bg-gray-700 divide-y divide-gray-600 rounded-lg shadow"
          id="user-dropdown">
          <div class="px-4 py-3">
          ...
          <ul class="py-2" aria-labelledby="user-menu-button">
            <li>
              <router-link to="/settings"
                class="block px-4 py-2 text-sm text-gray-200 hover:bg-gray-600 hover:text-white">Settings</router-link>
            </li>
            <li>
        ...
        <ul
          ...
          <li>
            <router-link to="/clocks/1"
              class="block py-2 px-3 text-white rounded hover:bg-gray-700 md:hover:bg-transparent md:hover:text-blue-500 md:p-0">Clock
