...
const handleSubmit = async (event: Event) => {
  ...
  let data = {
    status: status.value,
    time: new Date(date.value + " " + time.value),
    user_id: "1",
  };
...
<template>
  ...
  >
    ...
    <form class="max-w-sm mx-auto" @submit="handleSubmit">
      ...
      <button
        type="submit"
        class="text-white bg-blue-700 mt-3 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
      >
        Submit
      </button>
    </form>
